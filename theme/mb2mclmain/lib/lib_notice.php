 ...
 *
 */
function theme_mb2mclmain_notice ( $position = 'content')
{
    ...
    {
        $output .= theme_mb2mclmain_notice_item( $itemid, $position );
    }
 ...
 *
 */
function theme_mb2mclmain_notice_item ( $itemid, $position )
{
    global $CFG, $PAGE;
