 ...
 *
 */
function theme_mb2mclmain_body_cls($page)
{
	...
	// Page layout
	$output[] = 'theme-l' . theme_mb2mclmain_theme_setting($page, 'layout', 'fw');

	// Header style
	$output[] = 'header-' . theme_mb2mclmain_theme_setting($page, 'headerstyle', 'light');

	// Icon nav menu class
	if (theme_mb2mclmain_theme_setting($page, 'navicons') !== '' )
	{
		$output[] = 'isiconmenu';
	}

	// Custom login page
	if (theme_mb2mclmain_is_login($page, true))
	{
		$output[] = 'custom-login';
	}
	elseif ( theme_mb2mclmain_is_login($page, false) )
	{
	...
	if (theme_mb2mclmain_page_cls($page))
	{
		$output[] = theme_mb2mclmain_page_cls($page);
	}

	// Custom course pages class
	if (theme_mb2mclmain_page_cls($page, true))
	{
		$output[] = theme_mb2mclmain_page_cls($page, true);
	}

	// Custom course class
	if (theme_mb2mclmain_course_cls($page))
	{
		$output[] = theme_mb2mclmain_course_cls($page);
	}

	// Course category theme
	if (theme_mb2mclmain_courselist_cls($page))
	{
		$output[] = theme_mb2mclmain_courselist_cls($page);
	}

	// Fixed navigation
	if ( theme_mb2mclmain_theme_setting( $page, 'stickyheader' ) )
	{
		$output[] = 'sticky-header' . theme_mb2mclmain_theme_setting( $page, 'stickyheader' );
	}

	// Page predefined background
	if (!theme_mb2mclmain_is_login($page, true) && theme_mb2mclmain_theme_setting($page, 'pbgpre') !='')
	{
		$output[] = 'pre-bg' . theme_mb2mclmain_theme_setting($page, 'pbgpre');
	}

	// Login page predefined background
	if (theme_mb2mclmain_is_login($page, true) && theme_mb2mclmain_theme_setting($page, 'loginbgpre') !='')
	{
		$output[] = 'pre-bg' . theme_mb2mclmain_theme_setting($page, 'loginbgpre');
	}

	if (theme_mb2mclmain_theme_setting($page,'sidebarbtn') == 2)
	{
	...
	if (!theme_mb2mclmain_is_frontpage_content())
	{
		$output[] = 'fpempty';
	}

	if ( theme_mb2mclmain_course_layout_class() )
	{
		$output[] = theme_mb2mclmain_course_layout_class();
	}

	foreach ( theme_mb2mclmain_midentify() as $class )
	{
		$output[] = $class;
	}

	$output[] = theme_mb2mclmain_sidebar_cls();

	$output[] = 'page-sidebar-' . theme_mb2mclmain_theme_setting($page, 'pagesidebar');

	if ( theme_mb2mclmain_is_sidebar() )
	{
	...
	if ( theme_mb2mclmain_is_toc() && ! $PAGE->user_is_editing() )
	{
		$output[] = 'ctoc';
	}
 ...
 *
 */
function theme_mb2mclmain_sidebar_cls()
{
	global $PAGE;
 ...
 *
 */
function theme_mb2mclmain_is_frontpage_content()
{
 ...
 *
 */
function theme_mb2mclmain_is_login($page, $custom = false)
{
	...
	$customLoginPage = theme_mb2mclmain_theme_setting($page, 'cloginpage', '', 0);
 ...
 *
 */
function theme_mb2mclmain_themename ()
{
 ...
 *
 */
function theme_mb2mclmain_menu_data ($page, $attribs = array())
{

	$output = '';

	$output .= ' data-animtype="' . theme_mb2mclmain_theme_setting($page, 'navatype', 2) . '"';
	$output .= ' data-animspeed="' . theme_mb2mclmain_theme_setting($page, 'navaspeed', 300) . '"';
 ...
 *
 */
function theme_mb2mclmain_get_custom_files ($type)
{
	...
	{
		return theme_mb2mclmain_file_arr($cssDir, array('css'));
	}
	elseif (is_dir($jsDir) && $type == 2)
	{
		return theme_mb2mclmain_file_arr($jsDir, array('js'));
	}
 ...
 *
 */
function theme_mb2mclmain_file_arr ($dir, $filter = array('jpg','jpeg','png','gif'))
{
	...
	if (!is_dir($dir))
	{
		$output = get_string('foldernoexists','theme_mb2mclmain');
	}
	else
	{
 ...
 *
 */
function theme_mb2mclmain_random_image ($dir, $pixDirName, $attribs = array('jpg','jpeg','png','gif'))
{

	global $OUTPUT, $CFG;
	$moodle33 = 2017051500;
	$output = '';
	$arr = theme_mb2mclmain_file_arr($dir, $attribs);
 ...
 *
 */
function theme_mb2mclmain_font_icon ($page, $attribs = array())
{

	$output = '';

	//$faIcons = theme_mb2mclmain_theme_setting($page, 'ficonfa', 1);
	$ficon7stroke = theme_mb2mclmain_theme_setting($page, 'ficon7stroke', 1);
	$glyphIcons = theme_mb2mclmain_theme_setting($page, 'ficonglyph', 1);
	$lineIcons = 1;

	// if ($faIcons == 1)
	// {
	// 	$page->requires->css('/theme/mb2mclmain/assets/font-awesome/css/font-awesome.min.css');
	// }

	if ($ficon7stroke == 1)
	{
		$page->requires->css('/theme/mb2mclmain/assets/pe-icon-7-stroke/css/pe-icon-7-stroke.min.css');
	}

	if ($glyphIcons == 1)
	{
		$page->requires->css('/theme/mb2mclmain/assets/bootstrap/css/glyphicons.min.css');
	}

	if ($lineIcons == 1)
	{
		$page->requires->css('/theme/mb2mclmain/assets/LineIcons/LineIcons.min.css');
	}
 ...
 *
 */
function theme_mb2mclmain_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array())
{

	if ( $context->contextlevel == CONTEXT_SYSTEM )
	{
	    $theme = theme_config::load('mb2mclmain');
 ...
 *
 */
function theme_mb2mclmain_line_classes ($string, $id, $pref = '', $suff = '')
{
 ...
 *
 */
function theme_mb2mclmain_theme_setting ($page, $name, $default = '', $image = false, $theme= false)
{
	if ($theme)
	{
 ...
 *
 */
function theme_mb2mclmain_language_list ()
{
	...
	foreach ($langs as $langtype => $langname)
	{
		if ($langtype)
		{
			...
			$output .= theme_mb2mclmain_language_code($langtype);
			$output .= '</a>';
			$output .= '</li>';
		}
	}
 ...
 *
 */
function theme_mb2mclmain_language_code ($lang)
{
 ...
 *
 */
function theme_mb2mclmain_mycourses_list()
{

	global $CFG, $PAGE;
	$output = '';
	$courses = theme_mb2mclmain_get_mycourses();
	$limit = theme_mb2mclmain_theme_setting($PAGE, 'mcnamelimit', 6);
	...
	foreach ($courses as $c)
	{
		...
		$output .= theme_mb2mclmain_wordlimit($coursename, $limit);
		$output .= '</a>';
		$output .= '</li>';
	}
 ...
 *
 */
function theme_mb2mclmain_get_mycourses ()
{
	global $USER;
	...
	{
		$course_access = theme_mb2mclmain_site_access($c->id);
		...
		'roles' => implode(' ', theme_mb2mclmain_get_user_course_roles($c->id, $USER->id) ) );
	}
 ...
 *
 */
function theme_mb2mclmain_string_url_safe($string)
{
 ...
 *
 */
function theme_mb2mclmain_logo_url($page, $customLogo = '', $login = true)
{
	...
	$defaultLogo = theme_mb2mclmain_theme_setting( $page, 'headerstyle' ) === 'color'
	? $OUTPUT->image_url( 'logo-default-dark', 'theme' ) : $OUTPUT->image_url( 'logo-default', 'theme' );

	// Check if is custom login page
	$customLoginPage = theme_mb2mclmain_is_login($page, true);

	if ($login && $customLoginPage && theme_mb2mclmain_theme_setting($page,'loginlogo','', true) !='')
	{
		$isCustomLogo = theme_mb2mclmain_theme_setting($page,'loginlogo','', true);
	}
	else
	{
		$isCustomLogo = $customLogo !='' ? $customLogo : theme_mb2mclmain_theme_setting($page,'logo','', true);
	}
 ...
 *
 */
function theme_mb2mclmain_pagebg_image($page)
{
	...
	$pageBg = theme_mb2mclmain_theme_setting($page, 'pbgimage', '', true);
	$pageBgPre = theme_mb2mclmain_theme_setting($page, 'pbgpre', '');
	$pageBgLogin = theme_mb2mclmain_theme_setting($page, 'loginbgimage', '', true);
	$pageBgLoginPre = theme_mb2mclmain_theme_setting($page, 'loginbgpre', '');
 ...
 *
 */
function theme_mb2mclmain_loading_screen($page)
{

	global $OUTPUT, $SITE;
	$output = '';
	$logo_height = theme_mb2mclmain_theme_setting($page,'loadinglogoh');
	$bg_color = theme_mb2mclmain_theme_setting($page,'lbgcolor');
	...
	if (!is_siteadmin())
	{
		$output .= '<div class="loading-scr" data-hideafter="' . theme_mb2mclmain_theme_setting($page, 'loadinghide',600) . '"' . $style_bg_color . '>';
		$output .= '<div class="loading-scr-inner">';
		$output .= '<img class="loading-scr-logo" src="' .
		theme_mb2mclmain_logo_url($page, theme_mb2mclmain_theme_setting($page,'loadinglogo','', true), false) . '" alt="' . $SITE->shortname . '"' . $style_logo_height . '>';
		$output .= '<div class="loading-scr-spinner"><img src="' . theme_mb2mclmain_loading_spinner() . '" alt="' . get_string('loading','theme_mb2mclmain') . '" style="width:' . theme_mb2mclmain_theme_setting($page, 'spinnerw', 50) . 'px;"></div>';
		$output .= '</div>';
		$output .= '</div>';
	}
 ...
 *
 */
function theme_mb2mclmain_loading_spinner ()
{

	global $CFG;
	$output = '';

	$spinnerDir = $CFG->dirroot . '/theme/mb2mclmain/pix/spinners/';
	$spinnerCustomDir = $CFG->dirroot . '/theme/mb2mclmain/pix/spinners/custom';

	$spinner = theme_mb2mclmain_random_image($spinnerDir, 'spinners', array('gif','svg'));
	$spinnerCustom = theme_mb2mclmain_random_image($spinnerCustomDir, 'spinners/custom', array('gif','svg'));
 ...
 *
 */
function theme_mb2mclmain_scrolltt($page)
{
	...
	$output .= '<a class="theme-scrolltt" href="#" title="' . get_string('scrolltotop', 'theme_mb2mclmain') . '"><span><i class="fa fa-angle-up" data-scrollspeed="' .
	theme_mb2mclmain_theme_setting($page, 'scrollspeed',400) . '"></i></span></a>';
 ...
 *
 */
function theme_mb2mclmain_iconnav($page)
{

	$iconnavs = theme_mb2mclmain_theme_setting($page, 'navicons');

	if ($iconnavs !='')
	{
		return theme_mb2mclmain_static_content($iconnavs, array( 'listcls' => 'theme-iconnav' ) );
	}
 ...
 *
 */
function theme_mb2mclmain_ganalytics($page, $type = 1)
{

	$output = '';
	$codeId = theme_mb2mclmain_theme_setting($page, 'ganaid');
	$codeAsync = theme_mb2mclmain_theme_setting($page, 'ganaasync', 0);
 ...
 *
 */
function theme_mb2mclmain_favicon ($page)
{
	...
	$favImg = $CFG->dirroot . '/theme/mb2mclmain/pix/favicon/favicon-16x16.ico';

	// Additional favicons
	$favDeskDir = $CFG->dirroot . '/theme/mb2mclmain/pix/favicon/desktop/';
	$favMobDir = $CFG->dirroot . '/theme/mb2mclmain/pix/favicon/mobile/';
	$deskIcons = theme_mb2mclmain_file_arr($favDeskDir, array('png'));
	$mobIcons = theme_mb2mclmain_file_arr($favMobDir, array('png'));
 ...
 *
 */
function theme_mb2mclmain_show_hide_sidebars ($page, $vars = array())
{

	$output = '';

	$sidebarBtn = theme_mb2mclmain_theme_setting($page,'sidebarbtn');
	$showSdebar = ($sidebarBtn == 1 || $sidebarBtn == 2);

	if (isset($vars['sidebar']) && $vars['sidebar'] && $showSdebar)
	{
		$output .= '<a href="#" class="theme-hide-sidebar mode' . $sidebarBtn . '" data-showtext="' . get_string('showsidebar','theme_mb2mclmain') . '" data-hidetext="' .
		get_string('hidesidebar','theme_mb2mclmain') . '">';
		$output .= $sidebarBtn == 2 ? get_string('showsidebar','theme_mb2mclmain') : get_string('hidesidebar','theme_mb2mclmain');
		$output .= '</a>';
	}
 ...
 *
 */
function theme_mb2mclmain_midentify($vars = array())
{
 ...
 *
 */
function theme_mb2mclmain_plugins_arr()
{

	global $CFG;

	$output = array(
		//'mb2slider'=>array('text'=>get_string('mb2slider_plugin','theme_mb2mclmain'),'file'=>$CFG->dirroot . '/blocks/mb2slider/block_mb2slider.php'),
		'mb2shortcodes_filter'=>array('text'=>get_string('mb2shortcodes_filter_plugin','theme_mb2mclmain'),'file'=>$CFG->dirroot . '/filter/mb2shortcodes/filter.php'),
		//'mb2shortcodes_button'=>array('text'=>get_string('mb2shortcodes_button_plugin','theme_mb2mclmain'),'file'=>$CFG->dirroot . '/lib/editor/atto/plugins/mb2shortcodes/ajax.php')
	);
 ...
 *
 */
 function theme_mb2mclmain_check_plugins()
 {

 	$output = '';
 	$plugins = theme_mb2mclmain_plugins_arr();
 	$show_alert = 0;
 	...
 	foreach ( $plugins as $id => $plugin )
 	{
 		...
 		if ( $id === 'mb2shortcodes_filter' && ! theme_mb2mclmain_check_shortcodes_filter() )
 		{
 			$show_alert = 1;
 		}
 ...
 *
 */
function theme_mb2mclmain_wordlimit( $string, $limit = 999, $end = '...' )
{
 ...
 *
 */
function theme_mb2mclmain_moodle_from ($version)
{
	global $CFG;
 ...
 *
 */
function theme_mb2mclmain_is_user_role($courseid, $roleid, $userid = 0)
{
 ...
 *
 */
function theme_mb2mclmain_font_icon_prefix($icon)
{
 ...
 *
 */
function theme_mb2mclmain_page_title($coursename = true)
{
 ...
 *
 */
function theme_mb2mclmain_line_content($text)
{
 ...
 *
 */
function theme_mb2mclmain_static_content( $text, $options = array() )
{

	$output = '';
	$i = 0;
	$content = theme_mb2mclmain_line_content($text);
	$style = '';
	$listcls = '';
	$linkcls = '';
	...
	foreach ( $content as $item )
	{
		...
		if ($item['icon'])
		{
			$icon_pref = theme_mb2mclmain_font_icon_prefix($item['icon']);
		}
 ...
 *
 */
function theme_mb2mclmain_check_for_tags ($string, $tags = 'p|span|b|strong|i|u')
{
 ...
 *
 */
function theme_mb2mclmain_course_layout_class()
{

	global $PAGE;
	$output = '';
	$is_course_cat = ($PAGE->pagetype === 'course-index-category' && theme_mb2mclmain_theme_setting($PAGE, 'coursegridcat'));
	$is_course_fp = ($PAGE->pagetype === 'site-index' && theme_mb2mclmain_theme_setting($PAGE, 'coursegridfp'));
 ...
 *
 */
function theme_mb2mclmain_course_layout_switcher()
{
	global $PAGE;
	$output = '';
	$is_course_cat = ($PAGE->pagetype === 'course-index-category' && theme_mb2mclmain_theme_setting($PAGE, 'coursegridcat'));
	...
	get_string('layoutgrid', 'theme_mb2mclmain') . '" data-toggle="tooltip" data-trigger="hover"><i class="fa fa-th-large"></i></a>';
	$output .= '<a href="#" class="list-layout' . $actice_cls_list . '" title="' .
	get_string('layoutlist', 'theme_mb2mclmain') . '" data-toggle="tooltip" data-trigger="hover"><i class="fa fa-th-list"></i></a>';
	$output .= '</div>';
 ...
 *
 */
function theme_mb2mclmain_frontpage_courses()
{
 ...
 *
 */
function theme_mb2mclmain_check_shortcodes_filter()
{
	global $DB;
	$filters = array();
 ...
 *
 */
function theme_mb2mclmain_get_url_param ($url, $param = 'id')
{
	$parts = parse_url($url);
 ...
 *
 */
function theme_mb2mclmain_get_user_details ($id, $detail = 1, $options = array('size'=>148))
{
 ...
 *
 */
function theme_mb2mclmain_luminance ($hex, $percent)
{

	// Make sure that we have hex color
	if (preg_match('@rgb@', $hex))
	{
		$hex = theme_mb2mclmain_rgb_to_hex($hex);
	}
...
function theme_mb2mclmain_rgb_to_hex($color)
{
 ...
 *
 */
function theme_mb2mclmain_is_module_context()
{
 ...
 *
 */
function theme_mb2mclmain_is_footer_columns()
{
	global $PAGE;

	$a = theme_mb2mclmain_isblock($PAGE, 'bottom-a');
	$b = theme_mb2mclmain_isblock($PAGE, 'bottom-b');
	$c = theme_mb2mclmain_isblock($PAGE, 'bottom-c');
	$d = theme_mb2mclmain_isblock($PAGE, 'bottom-d');
 ...
 *
 */
function theme_mb2mclmain_is_sidebar()
{
	global $PAGE;

	if ( theme_mb2mclmain_isblock( $PAGE, 'page-sidebar' ) && ! theme_mb2mclmain_is_login( $PAGE, true ) || theme_mb2mclmain_is_toc() )
	{
		return true;
	}
 ...
 *
 */
function theme_mb2mclmain_get_fileareaimages( $filearea = null )
{
	...
	$fs = get_file_storage();
	$files = $fs->get_area_files( $context->id, 'theme_mb2mclmain', $filearea, 0, 'itemid, filepath, filename', false );
 ...
 *
 */
function theme_mb2mclmain_get_highlight_text( $text, $class = 'thintext' )
{
 ...
 *
 */
function theme_mb2mclmain_get_user_roles( $userid = null )
{
	global $DB;
	$roles = array();
 ...
 *
 */
function theme_mb2mclmain_get_user_course_roles( $courseid = null, $userid = null )
{
	global $DB;
	$courseroles = array();
	...
	$userroles = theme_mb2mclmain_get_user_roles( $userid );

	foreach ( $userroles as $userrole )
	{
		if ( $context->id == $userrole->contextid )
		{
			$courseroles[] = theme_mb2mclmain_get_role_shortname( $userrole->roleid );
		}
	}
 ...
 *
 */
function theme_mb2mclmain_get_role_shortname( $roleid = null )
{
 ...
 *
 */
function theme_mb2mclmain_header_actions()
{
	global $PAGE;

	$output = '';

	if ( ! theme_mb2mclmain_moodle_from( 2020110900 ) )
	{
		return;
	}
