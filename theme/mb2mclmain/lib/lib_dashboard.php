...
function theme_mb2mclmain_dashboard()
{

    $output = '';

    $output .= theme_mb2mclmain_dashboard_courses();
 ...
 *
 */
function theme_mb2mclmain_dashboard_courses ()
{
    ...
    $output .= '<span class="theme-dashboard-count">' . theme_mb2mclmain_dashboard_course_count('inprogress') . '</span>';
    $output .= '</a></li>';

    $output .= '<li><a href="#theme_dashboard_courses_future" data-toggle="tab">' . get_string('future','block_myoverview');
    $output .= '<span class="theme-dashboard-count">' . theme_mb2mclmain_dashboard_course_count('future') . '</span>';
    $output .= '</a></li>';

    $output .= '<li><a href="#theme_dashboard_courses_past" data-toggle="tab">' . get_string('past','block_myoverview');
    $output .= '<span class="theme-dashboard-count">' . theme_mb2mclmain_dashboard_course_count('past') . '</span>';
    $output .= '</a></li>';
    $output .= '</ul>';
    ...
    $courses_inprogress = theme_mb2mclmain_dashboard_courses_template('inprogress');
    ...
    $courses_future = theme_mb2mclmain_dashboard_courses_template('future');
    ...
    $courses_past = theme_mb2mclmain_dashboard_courses_template('past');
 ...
 *
 */
function theme_mb2mclmain_dashboard_courses_template ($classify)
{

    $output = '';
    $i = 0;
    $courses = theme_mb2mclmain_dashboard_courses_items($classify);
    ...
    foreach ($courses as $course)
    {
        if ($course->showitem)
        {
            ...
            // $output .= '</div>';
            $output .= theme_mb2mclmain_dashboard_course_progress_bar($course);
            // $output .= '</div>';
            // $output .= '</div>';
        }
    }
 ...
 *
 */
function theme_mb2mclmain_dashboard_course_progress_bar ($course)
{
    $output = '';
 ...
 *
 */
function theme_mb2mclmain_dashboard_courses_items ($classify)
{
 ...
 *
 */
function theme_mb2mclmain_dashboard_course_count ($classify)
{
    $i = 0;
    $courses = theme_mb2mclmain_dashboard_courses_items($classify);
