 ...
 *
 */
function theme_mb2mclmain_get_course_activities()
{
 ...
 *
 */
function theme_mb2mclmain_course_panel($name = '')
{
	...
	$output = '';
	$i= 0;
	$boxes = theme_mb2mclmain_teacher_boxes();
 ...
 *
 */
function theme_mb2mclmain_teacher_boxes()
{
	...
	$boxes = array(
		 ...
		 'course' => array(
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2mclmain_course_content()
		),
		'activities' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-list-ul',
			'links' => theme_mb2mclmain_links_activities()
		),
		'grade' => array(
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2mclmain_grades_content()
		),
		'studentbadges' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2mclmain_studentbadges_content()
		),
		'competencies' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2mclmain_competencies_content()
		),
		'progress' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2mclmain_progress_content()
		),
		'contacts' => array(
			'access' => array('student'),
			...
			'icon' => 'fa fa-users',
			'links' => '',
			'content' => theme_mb2mclmain_contacts_content(1,$context)
		),
		'qbank' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-question',
			'links' => theme_mb2mclmain_links_qbank()
		),
		'badges' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-trophy',
			'links' => theme_mb2mclmain_links_badges()
		),
		'badges2' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-trophy',
			'links' => theme_mb2mclmain_links_badges(false)
		),
		'course_settings' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-book',
			'links' => theme_mb2mclmain_links_course()
		),
		'students' => array(
			'access' => array('admin','manager','editingteacher'),
			...
			'links' => theme_mb2mclmain_links_students()
		),
		'students2' => array(
			'access' => array('teacher'),
			'title' => get_string('defaultcoursestudents'),
			'desc' => '',
			'icon' => 'fa fa-graduation-cap',
			'links' => theme_mb2mclmain_links_students(false)
		),
        'modulenav' => array(
			'access' => array('admin','manager','editingteacher'),
			'title' => theme_mb2mclmain_module_nav(true),
			'desc' => '',
            'show' => theme_mb2mclmain_is_module_context(),
			'icon' => 'fa fa-cogs',
			'links' => '',
            'content' => theme_mb2mclmain_module_nav()
		)
 ...
 *
 */
function theme_mb2mclmain_studentbadges_content()
{
 ...
 *
 */
function theme_mb2mclmain_competencies_content()
{
 ...
 *
 */
function theme_mb2mclmain_grades_content()
{
 ...
 *
 */
function theme_mb2mclmain_progress_content()
{
 ...
 *
 */
function theme_mb2mclmain_get_role_name($context,$user,$shortname)
{
 ...
 *
 */
function theme_mb2mclmain_contacts_content()
{
	...
	$roleshortname = theme_mb2mclmain_theme_setting($PAGE,'roleshortname','editingteacher');
	$teacheremail = theme_mb2mclmain_theme_setting($PAGE,'teacheremail');
	$teachermessage = theme_mb2mclmain_theme_setting($PAGE,'teachermessage');
		...
		$output .= '<ul>';
			...
			if ($count>0)
			{
				...
				foreach ($teachers as $teacher)
				{
					...
					$rolename = theme_mb2mclmain_get_role_name($context,$teacher,$roleshortname);
 ...
 *
 */
function theme_mb2mclmain_course_content()
{

	global $CFG, $COURSE, $PAGE;

	$output = '';
	$banner = theme_mb2mclmain_course_image_url( $COURSE->id );
	...
	$limit = theme_mb2mclmain_theme_setting($PAGE,'cpaneldesclimit',24);
	$content = theme_mb2mclmain_wordlimit($COURSE->summary,$limit);

	$output .= '<h3>' . theme_mb2mclmain_wordlimit($COURSE->fullname,6) . '</h3>';
 ...
 *
 */
function theme_mb2mclmain_links_students($edit = true)
{
	...
	$links = array(
		...
		array('url'=>new moodle_url('/report/loglive/index.php',array('id' => $COURSE->id)),'title'=>get_string('livelogs','theme_mb2mclmain')),
		array('url'=>new moodle_url('/report/participation/index.php',array('id' => $COURSE->id)),'title'=>get_string('courseparticipation','theme_mb2mclmain')),
 ...
 *
 */
function theme_mb2mclmain_links_course()
{
	...
	$links = array(
		...
		array('url'=>new moodle_url('/admin/tool/recyclebin/index.php',array('contextid' => $PAGE->context->id)),'title'=>get_string('recyclebin','theme_mb2mclmain'),'showif'=>$ifm33),
		array('url'=>new moodle_url('/filter/manage.php',array('contextid' =>  $PAGE->context->id)),'title'=>get_string('filters','admin')),
		array('url'=>new moodle_url('/admin/tool/monitor/managerules.php',array('courseid' => $COURSE->id)),'title'=>get_string('eventmonitoring','theme_mb2mclmain')),
 ...
 *
 */
function theme_mb2mclmain_links_badges($edit = true)
{
 ...
 *
 */
function theme_mb2mclmain_links_qbank()
{
 ...
 *
 */
function theme_mb2mclmain_links_activities()
{
	...
	$data = theme_mb2mclmain_get_course_activities();
 ...
 *
 */
function theme_mb2mclmain_module_nav ($title = false)
{

	global $PAGE;
	$output = '';

	if (!theme_mb2mclmain_is_module_context())
	{
		return null;
	}
    ...
    foreach($PAGE->settingsnav->children as $item1)
    {
        if ($item1->key === 'modulesettings')
        {
            ...
            {
                $output .= '<li>';
                $output .= theme_mb2mclmain_module_nav_item($item2);
                ...
                if (count($item2->children) > 0)
                {
                    ...
                    {
                        $output .= '<li>';
                        $output .= theme_mb2mclmain_module_nav_item($item3);
                        $output .= '</li>';
                    }
 ...
 *
 */
function theme_mb2mclmain_module_nav_item ($item)
{
 ...
 *
 */
function theme_mb2mclmain_panel_link ( $pos = 'content')
{
    global $PAGE, $COURSE;
