...
function mb2_shortcode_accordion($atts, $content= null){
	...
	extract(mb2_shortcode_atts( array(
		'show_all' => 0,
		'custom_class' => '',
		'accordion_active' => theme_mb2mclmain_shortcodes_global_opts('accordion', 'accordion_active', 1),
		'margin' => '',
		'parent' => 1
		), $atts)
	);
...
function mb2_shortcode_accordion_item($atts, $content= null){
	...
	$col_id = 'acc_item_' . theme_mb2mclmain_string_url_safe($title) . '_' . $accordion_count . '_' . $GLOBALS['accordion_item_count'] . '_';
	...
	$pref = theme_mb2mclmain_font_icon_prefix($icon);
