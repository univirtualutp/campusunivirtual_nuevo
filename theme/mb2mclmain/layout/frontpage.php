...
$sidebars = theme_mb2mclmain_theme_setting($PAGE, 'fpsidebars');
    ...
    <div class="container-fluid">
        <div class="row">
            <section id="region-main" class="content-col <?php echo $contentCol; ?>">
                <div id="page-content">
					<?php if (theme_mb2mclmain_frontpage_courses() && theme_mb2mclmain_theme_setting($PAGE, 'courseswitchlayout')) : ?>
						<?php echo theme_mb2mclmain_course_layout_switcher(); ?>
					<?php endif; ?>
					<?php if (is_siteadmin()): ?>
     		...
     		<?php if ($sidePre) : ?>
            	<div class="sidebar-col <?php echo $sidePreCol; ?>">
                	<?php echo $OUTPUT->blocks('side-pre', theme_mb2mclmain_block_cls($PAGE, 'side-pre')); ?>
                </div>
       		<?php endif; ?>
     		<?php if ($sidePost) : ?>
            	<div class="sidebar-col <?php echo $sidePostCol; ?>">
                	<?php echo $OUTPUT->blocks('side-post', theme_mb2mclmain_block_cls($PAGE, 'side-post')); ?>
                </div>
        	<?php endif; ?>
        </div>
    </div>
