...
$sidebar = theme_mb2mclmain_isblock($PAGE, 'side-pre');
        ...
        <div class="row">
     		<section id="region-main" class="content-col <?php echo $contentCol; ?>">
            	<div id="page-content">
					...
					<?php endif; ?>
					<?php if ($PAGE->pagetype === 'course-index-category' && isset($PAGE->category->id) && theme_mb2mclmain_theme_setting($PAGE, 'courseswitchlayout')) : ?>
