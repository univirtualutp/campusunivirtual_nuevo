...
<div id="page-sidebar">
    <div class="page-sidebar-inner">
        ...
        <?php if ( theme_mb2mclmain_is_toc() ) : ?>
            <?php echo theme_mb2mclmain_module_sections(true); ?>
        <?php endif; ?>
        <?php if ( theme_mb2mclmain_isblock( $PAGE, 'page-sidebar' ) ) : ?>
            <?php echo $OUTPUT->blocks( 'page-sidebar', theme_mb2mclmain_block_cls( $PAGE, 'page-sidebar', 'sidebar' ) ); ?>
        <?php endif; ?>
    </div>
</div>
