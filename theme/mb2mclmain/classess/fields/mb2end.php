...
if (!class_exists('admin_setting_configmb2end'))
{

	class admin_setting_configmb2end extends admin_setting 
	{
		...
		public function output_html($data, $query='') 
		{
			...
			$output .= $PAGE->pagetype !== 'admin-upgradesettings' ? '</div></div></div>' : '';
