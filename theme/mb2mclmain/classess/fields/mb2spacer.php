...
/**
 *
 * @package   theme_mb2mclmain2
 * @copyright 2017 Mariusz Boloz (https://mb2themes.com)
...
if (!class_exists('admin_setting_configmb2spacer'))
{
	...
	class admin_setting_configmb2spacer extends admin_setting 
	{
		...
		public function __construct($name, $hr = true, $visiblename = '', $description = '', $defaultsetting = '', $paramtype=PARAM_RAW, $size=null) 
		{
		...
		public function output_html($data, $query='') 
		{
			...
			$isHr = $this->hr === true ? ' mb2config-spacer-hr' : '';
			$output .= $PAGE->pagetype !== 'admin-upgradesettings' ? '<div class="mb2config-spacer' . $isHr . '"></div>' : '';
