...
if (!class_exists('admin_setting_configmb2color'))
{
	...
	class admin_setting_configmb2color extends admin_setting 
	{
		...
		public function output_html($data, $query='') 
		{
			...
			//$PAGE->requires->js('/theme/mb2mclmain2/assets/spectrum/spectrum.js');
			//$PAGE->requires->js('/theme/mb2mclmain2/assets/spectrum/spectrum_custom.js');	
