        ...
        <div class="row">
            ...
            <?php if ($sidePre) : ?>
            	<div class="sidebar-col <?php echo $sidePreCol; ?>">
                	<?php echo $OUTPUT->blocks('side-pre', theme_mb2mcl_block_cls($PAGE, 'side-pre','default')); ?>
                </div>
            <?php endif; ?>
            <?php if ($sidePost) : ?>
            <div class="sidebar-col <?php echo $sidePostCol; ?>">
            	<?php echo $OUTPUT->blocks('side-post', theme_mb2mcl_block_cls($PAGE, 'side-post','default')); ?>
            </div>
            <?php endif; ?>
        </div>
    </div>
