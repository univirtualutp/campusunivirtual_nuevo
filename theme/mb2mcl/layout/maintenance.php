...
$pageBgImg = $customLoginPage ? theme_mb2mcl_theme_setting($PAGE, 'loginbgimage', '', true) : theme_mb2mcl_theme_setting($PAGE, 'pbgimage', '', true);
...
<?php if (theme_mb2mcl_theme_setting($PAGE, 'scrolltt',0) == 1) :?>
