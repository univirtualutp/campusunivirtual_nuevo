...
$string['fontsmall'] = 'Small font';
$string['fontmedium'] = 'Medium font';
$string['fontbig'] = 'Big font';
$string['fontsize'] = 'Font size:';
$string['mb2slider_plugin'] = '<strong>Mb2 Slider</strong> block must be installed. Please see <a href="https://mb2themes.com/docs/macro-learning/#slider_installation" target="_blank">documentation</a>.';
$string['mb2shortcodes_filter_plugin'] = '<strong>Mb2 Shortcodes Filter</strong> plugin must be <strong>installed</strong> and <strong><u>activated</u></strong>. Please see <a href="https://mb2themes.com/docs/macro-learning/#sc_filter" target="_blank">documentation</a>.';
$string['mb2shortcodes_button_plugin'] = '<strong>Mb2 Shortcodes Button</strong> plugin must be installed. Please see <a href="https://mb2themes.com/docs/macro-learning/#sc_button" target="_blank">documentation</a>.';
$string['mb2slides_plugin'] = '<strong>Mb2 Slides</strong> plugin must be installed. Please see <a href="https://mb2themes.com/docs/macro-learning/#slider" target="_blank">documentation</a>';
...
$string['socialtitle'] = 'Connect with us';
$string['footerinfotitle'] = 'Contact us';
$string['continuewith'] = 'Continue with {$a}';


// Page builder
$string['cpanel'] = 'Content panel';
$string['imagepos'] = 'Image position';
...
$string['urldoc'] = 'https://mb2themes.com/docs/macro-learning/';
...
$string['logoimg'] = 'Logo Image';
$string['logoh'] = 'Logo Height (rem)';
$string['logohdesc'] = 'Logo height in rem. Logo width will be set automatically.';
$string['logomtb'] = 'Logo Margin Top/Bottom (rem)';
$string['logotitle'] = 'Logo Title Text';
$string['logotitledesc'] = 'Logo link "title" attribute. Require for SEO.';
$string['logoalttext'] = 'Logo Image Alternative Text';
$string['logoalttextdesc'] = 'Logo image "alt" attribute. Require for SEO.';
$string['pagewidth'] = 'Page Width (px)';
$string['langpos'] = 'Language List Position';
$string['langmargin'] = 'Language List Margin';
$string['sidebarpos'] = 'Sidebars Position';
$string['classic'] = 'Classic';
$string['layout'] = 'Layout';
$string['layoutfw'] = 'Full width';
$string['layoutfx'] = 'Boxed';
$string['pagesidebar'] = 'Page Sidebar';
$string['sidebarw'] = 'Page Sidebar Width (px)';
...
$string['foottext'] = 'Footer text';
$string['footmenu'] = 'Footer menu';
$string['footlogin'] = 'Login Info in Footer';
$string['regions'] = 'Block Regions';
$string['coursesettings'] = 'Courses';
$string['courseplimg'] = 'Course Placeholder Image';
$string['coursebtn'] = 'Enter Course Button';
$string['coursestudentscount'] = 'Enrolled Students';
$string['studentsroleid'] = 'Students Role ID';
$string['faviconimg'] = 'Favicon';
$string['favicondesc'] = 'Upload favicon image in "ico" format.';
$string['cbannerstyle'] = 'Course banner image';
$string['banner'] = "Image banner";
...
$string['topinfo'] = 'Top Bar Content';
$string['btinfo'] = 'Bottom Bar Content';
$string['navbarplugin'] = 'Messages and notifications plugins';
$string['staticinfodesc'] = 'Each line consists separated by pipe characters "|":<br>text::optional icon name|optional url::"1" to open link in a new window|language code or comma-separated codes|"1" to show text for logged in users only or "2" to show text for guests only.<br>For example:<pre>support@example.com::lni-envelope
+12 345 67 89::lni-phone-handset
Link with icon open in a new window::lni-link|http://example.com::1
English text||en
Spanish link text|http://example.com|es
English and Spanish text||en,es
Text for logged in users|||1
Text for guests|||2</pre>';
$string['staticmenudesc'] = 'Each line consists separated by pipe characters "|":<br>text|url::"1" to open link in a new window|language code or comma-separated codes|"1" to show item for logged in users only or "2" to show item for guests only.<br>For example:<pre>Menu item|http://example.com
Menu item open in a new window|http://example.com::1
Spanish menu item|http://example.com|es
Menu item for logged in users|http://example.com||1
Menu item for guests|http://example.com||2</pre>';
$string['courseswitchlayout'] = 'Course layout switcher';
$string['coursegridfp'] = 'Course grid on front page';
$string['coursegridcat'] = 'Course grid on category page';
$string['frontpage'] = 'Front page';
$string['slider'] = 'Slider';
$string['headerbtn'] = 'Header buttons';
$string['stickyheader'] = 'Sticky header';
$string['stickyheader2'] = 'Yes and hide on scroll down';
...
$string['bannerimg'] = 'Banner images';
$string['bannerimgdesc'] = 'You may upload up to 5 images';
...
// Settings navigation
$string['navatype'] = 'Aniamtion Type';
...
$string['naviconfsize'] = 'Icon Size (px)';
...
$string['mcnamelimit'] = 'Course Name Words Limit';
...
$string['socialheader'] = 'Top Bar Icons';
...
$string['loginlinks'] = 'Custom links next to login form';
$string['loginlinksdesc'] = 'Each line consists separated by pipe characters (|):<br>text::icon name|optional url::"1" to open link in a new window|language code or comma-separated codes|"1" to show text for logged in users only or "2" to show text for none logged in users only.<br>For example:<pre>How to find student login information?::lni-graduation|http://example.com::1
How to find teacher login information?::lni-user|http://example.com::1
How to create new account?::lni-lock|http://example.com</pre>';
$string['loginsocial'] = 'Social login buttons';
$string['sitemenu'] = 'Site menu';
$string['roleshortname'] = 'Teacher role shortname';
...
$string['searchlinks'] = 'Popular links below search form';
...
$string['fontsizer'] = 'Font size switcher';
...
$string['textcolor_lighten'] = 'Text color lighten';
$string['textcolor_footer'] = 'Text color in footer';
...
$string['lessvars'] = 'Custom Less Variables';
$string['lessvarsdesc'] = 'This is advanced option for users who understand how less variables works. You may overwrite less variables which are defined in \'variables.less\' file located in \'less\' folder of the theme. To overwrite variable use: @variable_name:variable_value. You may overwrite more than one variable using \'|\' separator, for example:<br><pre>@color_success:#119d65|@color_warning:#fb8b24</pre>';
...
$string['fsizepxdesc'] = 'Require for font size switcher.';
$string['fweight'] = 'Font Weight';
$string['gfont'] = 'Google Font';
$string['fsbase'] = 'Normal font size (px)';
$string['fsbase2'] = 'Medium font size (px)';
$string['fsbase3'] = 'Large font size (px)';
$string['hsize'] = 'Heading {$a->size} size (rem)';
...
$string['fwbold'] = 'Font weight for bold elements';


// Settings pages
$string['pagelogin'] = 'Login Page';
