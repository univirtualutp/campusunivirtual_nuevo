 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_mb2items implements templatable {
     ...
     */
    public function MoodleQuickForm_mb2items($elementName=null, $elementLabel=null, $attributes=null) {
    ...
    public function toHtml() {
        ...
        if ($this->_hiddenLabel){
            ...
            return '<label class="accesshide" for="'.$this->getAttribute('id').'" >'.
                        $this->getLabel() . 'asasasasasasasasa</label>' . $html;
        } else {
             return $html;
        }
    }
